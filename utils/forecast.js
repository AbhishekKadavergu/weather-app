...
const forecast = (latitude, longitude, callback)=>{
    ...
    url= "http://api.weatherstack.com/current?access_key=3d1cba0595dfe15d1a0afc0fcc67fce2&query="+latitude+","+longitude
    ...
    request({url: url, json: true}, (error, res)=>{
        if(error){
            ...
            callback(undefined, {
                location: res.body.location.name +" "+ res.body.location.region +" "+ res.body.location.country,
